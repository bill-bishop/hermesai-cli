import type { Msg, ToolSpec, ProviderResponse, ToolCall } from "../../core/types";
...
// ---- HTTP helpers ----
export async function openaiCreateResponse(body: any) {
...
export function extractAssistantText(resp: any) {
  let buf = "";
...
function safeJsonParse(s: any) { try { return JSON.parse(s); } catch { return s; } }
